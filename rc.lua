...
---autostart applications with specific tags
---{{{
awful.util.spawn_with_shell("run_once unclutter")
awful.util.spawn_with_shell("run_once terminator")
...
--}}}
-- this function is used to strip off contents from the string whuch is read from a file
         ...
         function lower_conky()
            ...
            local function network_speed()
               ...
               if wifi_status == 'up' then 
                  vicious.register(netwidget, vicious.widgets.net, '<span color="#CC9393">w ${wlp3s0 down_kb}</span> <span color="#7F9F7F">${wlp3s0 up_kb}</span>', 3)
                  elseif ethernet_status == 'up' then 
                     vicious.register(netwidget, vicious.widgets.net, '<span color="#CC9393">e ${enp4s0f2 down_kb}</span> <span color="#7F9F7F">${enp4s0f2 up_kb}</span>', 3)
                  else
               ...
               -- No border for maximized client  
               ...
               local function bat_notification()
                  ...
                  if (bat_capacity <=15 and bat_status == "Discharging") then
                     ...
                     , text       = "get ur ass off u lazy piece of shit :P ! " .. bat_capacity .."%" .. " left!"
                     , fg="#ff0000"
                     , bg="#deb887"
                     , timeout    = 15
